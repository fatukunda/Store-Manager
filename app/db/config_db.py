...
def connect():
    ...
    if set_config['test']:
        ...
        conn = psycopg2.connect(database='dektsfu001hn6g', user='plwlxtobexznlo', password='752178d58b5ffaebe1e11a9000136b77d76035f5dea0d2c82926236f2dcd2385', host = 'ec2-184-73-199-189.compute-1.amazonaws.com')
    else:
